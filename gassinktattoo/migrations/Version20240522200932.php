 ...
 */
final class Version20240522200932 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carrito_item (id INT NOT NULL, carrito_id INT NOT NULL, producto_id INT DEFAULT NULL, merchandising_id INT DEFAULT NULL, size VARCHAR(255) DEFAULT NULL, quantity INT NOT NULL, PRIMARY KEY(id))');
